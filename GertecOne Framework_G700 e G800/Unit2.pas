...
//**********************************************
procedure TForm2.edtParcelasKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
...
//**********************************************
function TForm2.OnActivityResult(RequestCode, ResultCode: Integer; Data:
JIntent): Boolean;
var
  json: JString;
  objJson: TJSONObject;
...
//**********************************************
procedure TForm2.HandleActivityMessage(const Sender: TObject; const M: TMessage);
begin
...
//************************************************
procedure TForm2.ExecuteTEF(Tipo,Id,Amount,Parcelas,TipoParcelamento,Product,HabilitaImpressao:string);
var
Intent:JIntent;
JSON:JString;
DeviceType:String;
...
//**********************************************
procedure TForm2.cmdEnviarTransacaoClick(Sender: TObject);
var
...
procedure TForm2.cmdCancelarTransacaoClick(Sender: TObject);
var
...
//**********************************************
procedure TForm2.FuncoesDiversas(Funcao:String);
begin
  try
...
//**********************************************
procedure TForm2.cmdFuncoesClick(Sender: TObject);
begin
FuncoesDiversas(GER7_FUNCOES);
end;
//**********************************************
procedure TForm2.cmdReimpressaoClick(Sender: TObject);
var
strAux:string;
begin
